...
<head>
	<meta charset="UTF-8">
	<title>ciMyBlog</title>
	<link rel="stylesheet" href="https://bootswatch.com/flatly/bootstrap.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/style.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/font-awesome.min.css">
	<script src="http://cdn.ckeditor.com/4.7.2/standard/ckeditor.js"></script>
</head>
<body>
<nav class="navbar navbar-default">
	<div class="container">
		<div class="navbar-header">
			<a href="<?php echo base_url(); ?>" class="navbar-brand">ciMyBlog</a>
		</div>
		<div id="navbar">
			<ul class="nav navbar-nav">
				...
				<li><a href="<?php echo base_url(); ?>upload_files/index">Upload Files</a></li>
				<li><a href="<?php echo base_url(); ?>rss_feed/index">RSS Feed</a></li>
			</ul>
...
<?php if($this->session->flashdata('file_deleted')): ?>
	<?php echo '<p class="alert alert-success text-center">'.$this->session->flashdata('file_deleted').'</p>' ?>
<?php endif; ?>